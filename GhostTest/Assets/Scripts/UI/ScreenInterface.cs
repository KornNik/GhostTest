        ...
        public void Execute(ScreenTypes screenType)
        {
            ...
            switch (screenType)
            {
                ...
                case ScreenTypes.MainMenu:
                    ...
                    break;
                case ScreenTypes.EndRaceMenu:
                    _currentWindow = _screenFactory.GetEndRaceMenu();
                    break;
                default:
                    break;
            }
        ...
        public void AddObserver(ScreenTypes screenType, IListenerScreen listenerScreen)
        {
            switch (screenType)
            {
                ...
                case ScreenTypes.MainMenu:
                    ...
                    break;
                case ScreenTypes.EndRaceMenu:
                    _screenFactory.GetEndRaceMenu().ShowUI += listenerScreen.ShowScreen;
                    _screenFactory.GetEndRaceMenu().HideUI += listenerScreen.HideScreen;
                    _screenFactory.GetEndRaceMenu().Hide();
                    break;
                default:
                    break;
            }
